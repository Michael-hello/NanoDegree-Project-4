...
APP.Main = (function() {
      ...
      for (var k = 0; k < kids.length; k++) {
        ...
        APP.Data.getStoryComment(kids[k], function(commentDetails) {
          ...
          comment.innerHTML = storyDetailsCommentTemplate(
              commentDetails,
              localeData); }
          catch(error) { console.log("error pulling comments")}
        });
      }
  ...
  function hideStory(id) {
    ...
    storyDetails.style.left = winWidth + "px" ;
    var timeOut = setTimeout(function(){storyDetails.remove();}, 300);
   }
